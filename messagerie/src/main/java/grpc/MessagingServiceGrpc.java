...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Msg.Message,
      Msg.EmptyResponse> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = Msg.Message.class,
      responseType = Msg.EmptyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Msg.Message,
      Msg.EmptyResponse> getSendMessageMethod() {
    io.grpc.MethodDescriptor<Msg.Message, Msg.EmptyResponse> getSendMessageMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getSendMessageMethod = MessagingServiceGrpc.getSendMessageMethod) == null) {
          MessagingServiceGrpc.getSendMessageMethod = getSendMessageMethod = 
              io.grpc.MethodDescriptor.<Msg.Message, Msg.EmptyResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Msg.EmptyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Msg.User,
      Msg.MessagesResponse> getGetMessagesForUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMessagesForUser",
      requestType = Msg.User.class,
      responseType = Msg.MessagesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Msg.User,
      Msg.MessagesResponse> getGetMessagesForUserMethod() {
    io.grpc.MethodDescriptor<Msg.User, Msg.MessagesResponse> getGetMessagesForUserMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getGetMessagesForUserMethod = MessagingServiceGrpc.getGetMessagesForUserMethod) == null) {
          MessagingServiceGrpc.getGetMessagesForUserMethod = getGetMessagesForUserMethod = 
              io.grpc.MethodDescriptor.<Msg.User, Msg.MessagesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "GetMessagesForUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Msg.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Msg.MessagesResponse.getDefaultInstance()))
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessage(Msg.Message request,
        io.grpc.stub.StreamObserver<Msg.EmptyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSendMessageMethod(), responseObserver);
    }

    /**
     */
    public void getMessagesForUser(Msg.User request,
        io.grpc.stub.StreamObserver<Msg.MessagesResponse> responseObserver) {
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
    ...
    /**
     */
    public Msg.EmptyResponse sendMessage(Msg.Message request) {
    ...
    /**
     */
    public Msg.MessagesResponse getMessagesForUser(Msg.User request) {
      return blockingUnaryCall(
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Msg.EmptyResponse> sendMessage(
        Msg.Message request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Msg.MessagesResponse> getMessagesForUser(
        Msg.User request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((Msg.Message) request,
              (io.grpc.stub.StreamObserver<Msg.EmptyResponse>) responseObserver);
          break;
        case METHODID_GET_MESSAGES_FOR_USER:
          serviceImpl.getMessagesForUser((Msg.User) request,
              (io.grpc.stub.StreamObserver<Msg.MessagesResponse>) responseObserver);
          break;
        default:
